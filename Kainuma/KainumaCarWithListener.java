...
public class KainumaCarWithListener extends AbstCar implements KeyListener, ColorChangeListener {

	public static void main(String[] args) {
		LCD.drawString("ButtonEventCar", 0, 0);
		TimeKeeper car = new KainumaCarWithListener();
		car.start();
	}

	public KainumaCarWithListener() {
